...
const packages: Package[] = [
  {
    ...
    archives: {
      'darwin-x64': {
        url: 'http://localhost:8081/kibana-ci-proxy-cache/node-re2/uhop/node-re2/releases/download/1.17.4/darwin-x64-93.gz',
        sha256: '9558c5cb39622e9b3653203e772b129d6c634e7dbd7af1b244352fc1d704601f',
      },
      'linux-x64': {
        url: 'http://localhost:8081/kibana-ci-proxy-cache/node-re2/uhop/node-re2/releases/download/1.17.4/linux-x64-93.gz',
      ...
      'linux-arm64': {
        url: 'http://localhost:8081/kibana-ci-proxy-cache/node-re2/uhop/node-re2/releases/download/1.17.4/linux-arm64-93.gz',
      ...
      'darwin-arm64': {
        url: 'http://localhost:8081/kibana-ci-proxy-cache/node-re2/uhop/node-re2/releases/download/1.17.4/darwin-arm64-93.gz',
        sha256: 'd4b708749ddef1c87019f6b80e051ed0c29ccd1de34f233c47d8dcaddf803872',
      },

      'win32-x64': {
        url: 'http://localhost:8081/kibana-ci-proxy-cache/node-re2/uhop/node-re2/releases/download/1.17.4/win32-x64-93.gz',
